...
## 2. *시연 동영상*
https://youtu.be/w-Q_QPlQyB0?si=gkryTxi4dkP3aY9c 
...
## 4. *사용한 기술*
![image](https://github.com/dbrudsodlf/4our_project_Frontend/assets/43839967/c23ac853-9102-4390-a2cc-1e684f55a2cc)

#### Front-end : React-Native, Axios, Redux
#### Back-end : Node.js, AWS-EC2
#### Data : Mongo DB, Maria DB, 웹크롤링, 공공데이터
#### 이미지 인식 : CNN

## 5. *ERD*
![image](https://github.com/dbrudsodlf/4our_project_Frontend/assets/43839967/dca1de9a-c0d4-456e-bb5f-204477eaf4b9)

 
## 6. *주요 기능*

### 1. 촬영 유도 화면
#### 촬영을 통한 재료 인식이 주된 기능이기때문에 첫 화면에서 촬영을 유도한다.
...
### 2. 내 냉장고 속 재료 확인 화면
#### 촬영 또는 검색을 통해 저장한 재료들을 확인할 수 있다. 
#### 재료의 유통기한, 냉장/냉동 여부 또한 확인할 수 있다.
...
### 3. 재료를 추가하는 방법
#### 바로 촬영방법 또는 보관중 사진으로 이미지 인식을 통한 재료 추가 가능
#### 원하는 식재료를 검색하여 재료추가 가능
